                  ...
                  Column(children: [
                    ...
                    CustomStepperWidget(
                      ...
                      isComplete: status == OrderConstants.confirmed
                          || status == OrderConstants.prescriptionApproved
                    ...
                    CustomStepperWidget(
                      title: getTranslated('prescription_approved', context),
                      isComplete: status == OrderConstants.prescriptionApproved
                          || status == OrderConstants.processing
                          || status == OrderConstants.outForDelivery
                          || status == OrderConstants.delivered,
                      isActive: status == OrderConstants.prescriptionApproved,
                      statusImage: Images.orderAccepted, // You can create a specific icon later
                    ),
