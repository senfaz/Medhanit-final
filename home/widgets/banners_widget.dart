        ...
        return Column(
          children: [
            Container(
              ...
              height: ResponsiveHelper.isDesktop(context) ? 550 : size.width * 0.49,
                ...
                children: [
                  CarouselSlider.builder(
                    options: CarouselOptions(
                      autoPlay: true,
                      enlargeCenterPage: ResponsiveHelper.isDesktop(context) ? false : true,
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: CustomImageWidget(
                              height: ResponsiveHelper.isDesktop(context) ? 450 : size.width * 0.5,
                              width: ResponsiveHelper.isDesktop(context) ? 700 : size.width,
                              placeholder: Images.placeHolder,
                              image: Provider.of<SplashProvider>(context, listen: false).baseUrls?.bannerImageUrl != null
                                  ? '${Provider.of<SplashProvider>(context, listen: false).baseUrls!.bannerImageUrl}/${bannerProvider.bannerList![index].image ?? ''}'
                                  : '',
                              fit: BoxFit.cover,
                            ),
                          ),
