      ...
      Container(
        ...
        child: !locationProvider.isLoading ? CustomButtonWidget(
          ...
          onPressed: locationProvider.loading ? null : () {
            ...
            // REMOVED: Service area restriction logic
            // Allow customers to add any address - backend will handle validation if needed
            bool isAvailable = true;

            // Proceed with address creation without location restrictions
            if(!isAvailable) {
