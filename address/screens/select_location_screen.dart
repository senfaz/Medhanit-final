  ...
  Widget build(BuildContext context) {
    ...
    return Selector<LocationProvider, String?>(
      ...
      builder: (context, pickAddress, child) {
        // Don't show fallback messages in fullscreen map search bar
        String displayText = '';
        if (pickAddress != null && pickAddress.isNotEmpty && !pickAddress.contains('Address not found')) {
          displayText = pickAddress;
        } else {
          displayText = getTranslated('search_here', context);
        }
