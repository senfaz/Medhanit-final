            ...
            child: Row(children: [
              ...
              Expanded(child: CustomButtonWidget(buttonText: getTranslated('yes_pay', context), onPressed: (){
                if(isPartialPay){
                  ...
                  orderProvider.savePaymentMethod(index: orderProvider.paymentMethodIndexCompat, method: orderProvider.paymentMethod);
                }
                Navigator.pop(context);

                if(isPartialPay) {
                  ResponsiveHelper().showDialogOrBottomSheet(context,  PaymentMethodBottomSheetWidget(totalPrice: totalPrice,), isScrollControlled: true);
                }
              })),
            ]),
          ),
