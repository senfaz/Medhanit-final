  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<OrderProvider>(builder: (ctx, orderProvider, _) {
      ...
      bool isSelected = CheckOutHelper.isPartialPaymentSelected(
        paymentMethodIndex: orderProvider.paymentMethodIndexCompat,
...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.color = const Color(0xffffffff).withValues(alpha: 0);
    path = Path();
    path.lineTo(0, 0);
    ...
    paint.color = const Color(0xffff5252).withValues(alpha: 1);
    path = Path();
    ...
    paint.color = const Color(0xffffab40).withValues(alpha: 1);
    path = Path();
