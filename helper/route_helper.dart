...
import 'package:flutter_grocery/features/payment/screens/telebirr_payment_screen.dart';
...
class RouteHelper {
  ...
  static const String telebirrPayment = '/telebirr-payment';
  ...
  static String getTelebirrPaymentRoute({required double amount}) {
    return '$telebirrPayment?amount=$amount';
  }
  ...
  static final Handler _telebirrPaymentHandler = Handler(
    handlerFunc: (context, Map<String, dynamic> params) {
      double? amount = double.tryParse(params['amount']?[0] ?? '0');
      return _routeHandler(child: TelebirrPaymentScreen(amount: amount ?? 0.0));
    },
  );
  ...
  static void setupRouter(){
    ...
    router.define(telebirrPayment, handler: _telebirrPaymentHandler, transitionType: TransitionType.fadeIn);
